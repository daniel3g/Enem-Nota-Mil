    ...
    <div className='flex w-full h-screen'>
      ...
      <div className='flex flex-col w-full justify-center items-center sm:w-1/3'>
        ...
        <form className='flex flex-col w-full p-3 sm:w-96'>
          ...
          <input className='flex bg-gray-900 p-3 mb-5 focus:outline-none focus:ring focus:ring-primary_blue rounded-sm' id="email" name="email" type="email" required />
          <label className='text-gray-500 text-sm' htmlFor="password">Senha:</label>
          <input className='flex bg-gray-900 p-3 mb-5 focus:outline-none focus:ring focus:ring-primary_blue rounded-sm' id="password" name="password" type="password" required />
          <button className='bg-primary_blue p-4 rounded-sm mt-2 text-xl' formAction={login}>Entrar</button>

          <a href="/cadastro"><div className='flex flex-col bg-gray-900 sm:w-full p-4 mt-5 rounded-md'>
